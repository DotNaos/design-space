...
export const sourceViewportPresets: readonly SourceViewportPreset[] = [
  { id: "responsive", label: "Responsive", device: "responsive", width: 960, height: 900 },
  { id: "desktop-1440", label: "Desktop · 1440 × 900", device: "desktop", width: 1440, height: 900 },
  { id: "desktop-1280", label: "Desktop · 1280 × 800", device: "desktop", width: 1280, height: 800 },
  { id: "tablet-1024", label: "Tablet · 1024 × 1366", device: "tablet", width: 1024, height: 1366 },
  { id: "tablet-768", label: "Tablet · 768 × 1024", device: "tablet", width: 768, height: 1024 },
  { id: "mobile-430", label: "Mobile · 430 × 932", device: "mobile", width: 430, height: 932 },
  { id: "mobile-390", label: "Mobile · 390 × 844", device: "mobile", width: 390, height: 844 },
  { id: "mobile-375", label: "Mobile · 375 × 812", device: "mobile", width: 375, height: 812 },
];
