...
import { appendFixtureChild, createTargetViewModel, findComponentFixture, findComponentInstance, renderTargetFixture, resolveFixtureProps } from "./target-model";
...
import { FixtureUndo, SlotSelection, TargetResult, getInitialClassName, initialSelection, initialVersion, isMobileWorkspace, messageFor, safeInitialView, statusLabel } from "./App";
